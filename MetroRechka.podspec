#
#  Be sure to run `pod spec lint MetroRechka.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.description  = "Metro rechka"

  spec.homepage     = "https://github.com/MosMetro-official/MetroRechka"
  ...
  spec.author             = { "Гусейн Римиханов" => "rimikhanov-gr@mosmetro.ru" }
  # Or just: spec.author    = "Гусейн Римиханов"
  # spec.authors            = { "Гусейн Римиханов" => "rimikhanov-gr@mosmetro.ru" }
  # spec.social_media_url   = "https://twitter.com/Гусейн Римиханов"
  ...
  spec.source       = { :git => "https://github.com/MosMetro-official/MetroRechka.git", :tag => "#{spec.version}" }
